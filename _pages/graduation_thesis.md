...
- 傾聴応答がされた根拠の推定
- 傾聴的な応答における語り手の嗜好の反映
- 読みやすさを考慮した字幕生成のための改行挿入と文圧縮の統合

#### 2024年度

- 自動生成字幕の短縮における訳抜けの利用可能性の検証
- 傾聴応答システムに向けた連続的な応答タイミング予測
- 「音韻」の概念を考慮可能なテキスト生成AIの開発
- 傾聴を示す応答の生成における語りの感情情報の利用
- 強化学習を用いた短文圧縮における精度改善
...
- 傾聴態度を示す応答の系列の生成における履歴と応答種類の利用（2025年度修了）
